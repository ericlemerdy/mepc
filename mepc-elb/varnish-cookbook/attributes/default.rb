...
default['varnish']['backend_jenkins_name'] = 'jenkins'
default['varnish']['backend_jenkins_host'] = 'mepc-jenkins'
default['varnish']['backend_jenkins_port'] = '8080'
default['varnish']['backend_jenkins_url'] = 'jenkins'
